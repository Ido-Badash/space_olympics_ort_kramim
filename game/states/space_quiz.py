...
class SpaceQuiz(BaseState):
    def __init__(self, game=None):
        ...
        self.questions = [
            {
                "question": "What creates the strong thrust that lifts a powerful rocket off the ground?",
                "options": [
                    "The rotation of Earth underneath the rocket",
                    "The rapid release of hot gases produced by burning large amounts of fuel",
                    "Air pressure pushing the rocket upward",
                    "Magnetic forces generated by the rocket's engines",
                ],
                "correct": 1,  # Index of correct answer (B)
            },
            {
                "question": "Why does space communication rely on satellites, lasers, and radio waves?",
                "options": [
                    "Because sound waves travel faster in space",
                    "Because there is no gravity in space",
                    "Because there is no atmosphere for sound waves to travel through",
                    "Because satellites cannot communicate through Earth's atmosphere",
                ],
                "correct": 2,  # Index of correct answer (C)
            },
            {
                "question": "How does the space communication system generally work?",
                "options": [
                    "Satellites create their own signals and send them randomly to Earth",
                    "A signal is sent from the ground, the satellite receives and amplifies it, then sends it to another point on Earth",
                    "Signals can only travel from one satellite to another, not to Earth",
                    "Satellites record messages and play them back hours later",
                ],
                "correct": 1,  # Index of correct answer (B)
            },
            {
                "question": "What is the purpose of life-support systems in spacecraft?",
                "options": [
                    "To launch the spacecraft into orbit",
                    "To protect the spacecraft from meteors",
                    "To supply astronauts with the necessary conditions to survive in space",
                    "To operate the communication systems",
                ],
                "correct": 2,  # Index of correct answer (C)
            },
        ]
        ...
        # Next button (shown after quiz complete)
    ...
    def startup(self):
        pygame.display.set_caption("Space Knowledge Quiz")
    ...
    def _draw_question(self, screen):
        """Draw the current question with modern styling"""
        w, h = self.game.size
    ...
    def _draw_completion(self, screen):
        ...
        sub_surf, sub_rect = self.game.font.render(
            "Knowledge Verified - Cleared for Launch",
            Colors.ICE_BLUE,
